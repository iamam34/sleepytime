...
"""
3 Jun 2013. Amy Martin. Mimicking/inspired by http://sleepyti.me

Potential improvements: add "now" option. add GUI. add memory/caching/serialisation/pickling. add "I have to get up at __:__" option. Read
"""
...
def calculateWaketimes(bedtime):
    ...
    times = list()
    for sleep_cycle_num in xrange(MIN_CYCLES, MAX_CYCLES):
...
def calculateBedtimes(waketime):
    ...
    times = list()
    for sleep_cycle_num in xrange(MAX_CYCLES, MIN_CYCLES, -1): #loop backwards
